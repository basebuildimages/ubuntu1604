...
RUN apt-get update -yqq && apt-get install -yqq python-dev wget git lib32stdc++6 libcups2-dev libsmbclient-dev python-distutils-extra libapt-pkg-dev python-apt libssl-dev gcc python3-dev nano net-tools oracle-java8-installer libffi-dev  libswt-gtk-3-jni libswt-gtk-3-java
